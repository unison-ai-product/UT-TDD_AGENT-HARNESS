...
是正方針として採った線も記録する。個人 home prefix (C:\Users\<user> など) のみを ~ へ置換し、worktree 名は残した。どの worktree を指すかは記録の情報価値そのもので、落とすと memory の主張が検証不能になる。PII 境界を守りつつ検証可能性を壊さない粒度がこれである。
