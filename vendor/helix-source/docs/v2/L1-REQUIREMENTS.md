...
| ID | 要件 | 受入条件 |
|---|---|---|
| **FR-INV01** | V1 capability 棚卸し doc 起票 | `docs/v2/A-audit/capability-inventory.md` で 12+ capability (V-model schema / 14 detector / 契約 extractor / handover / skill 推挙 / Reverse / Scrum / AI Harness Runtime Bridge 散在 / PMO / pm-tl-advisor / Stop hook / Codex/Claude harness) を実装状態 (実装済 / 部分実装 / carry / 廃止) + 起源 PLAN 付きで列挙 |
...
#### AI Harness Runtime Bridge サブ層整理 (Phase H、派生)
...
- ✅ FE 弱点強化 (Phase G)
- ✅ AI Harness Runtime Bridge 整理 (Phase H)
...
| **派生要件** | 2 Base 軸からの派生 (FE 強化 / AI Harness Runtime Bridge / 集大成 / Legacy Import) |
