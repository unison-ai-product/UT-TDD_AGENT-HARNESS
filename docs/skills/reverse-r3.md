...
upstream: vendor/helix-source/skills/workflow/reverse-r3
---
...
保存先: `docs/reverse/session-hypothesis-log.md`
...
必須ドキュメント: `docs/reverse/session-hypothesis-log.md`
...
- R4 完了時に Forward UT-TDD（L1/L2/L3/L4）へ接続する
