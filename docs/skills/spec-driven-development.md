...
upstream: vendor/helix-source/skills/agent-skills/spec-driven-development
---
...
In the UT-TDD V-model, this skill activates at L1 (requirements) and L3 (detailed design). The spec's success criteria become the basis for test design at the corresponding V-model layer. Use `ut-tdd plan lint` to verify that spec content has been properly traced to design artifacts.
