...
applies_to:
  layers: [L3, L4, L6]
  drive_models: [Forward, Reverse, Add-feature, Refactor]
upstream: vendor/helix-source/skills/workflow/dependency-map
---
...
ライセンス互換性マトリクス・リスクレベルの詳細は `docs/skills/` 内の compliance スキルを参照。

### クイックリファレンス

```
OK  : MIT, Apache-2.0, BSD, ISC
注意: LGPL, MPL-2.0
禁止: GPL, AGPL, SSPL
```
