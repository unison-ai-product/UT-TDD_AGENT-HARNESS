...
applies_to:
  layers: [L3, L7, L8, L9, L10, L11, L12]
  drive_models: [Forward, Add-feature, Reverse, Retrofit]
upstream: vendor/helix-source/skills/agent-skills/security-and-hardening
---
...
|   |   +-- YES --> Fix immediately
|   |   +-- NO (dev-only, unused code path) --> Fix soon, not a blocker
|   +-- Is a fix available?
|       +-- YES --> Update to the patched version
|       +-- NO --> Check workarounds or replace the dependency
+-- Severity: moderate
