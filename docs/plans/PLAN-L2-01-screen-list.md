...
title: "PLAN-L2-01 (design): L2 画面一覧 screen-list 本起票 — 14 画面に URL 設計 / ID↔URL 1:1 / 認証認可 / ステート保持を確定"
kind: design
layer: L2
sub_doc: screen-list
drive: be
...
PLAN-L2-00 master の Step 2。L1 で確定済みの 14 画面 (PM/HM/GD) を、L2 画面設計の `screen-list` sub-doc
...
- [x] 14 画面 ID (PM-01..05 / HM-01..08 / GD-01) を L1 と一致で列挙、各 L1 参照 §を明記。
