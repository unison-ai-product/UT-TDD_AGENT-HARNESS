...
admission_receipt:
  schema_version: v2
  receipt_id: certificate:b2339c5b585f65c15c6c1b0986f62688
  command_id: plan-revise:issue-676:pr1:identity-root:v3:ecbc4f9e
  admitted_at: 2026-09-25T12:00:00+09:00
  source_digest: sha256:ee63fc1fee5362051c286995d0617dfeccf26e62e9a0ede137e672ac06be83e6
  decision_digest: sha256:0f7193ac335e2c0783bd9463ea5eb26cfa15ebe9bfed813f16e4db8847942ce7
  receipt_digest: sha256:093bc3de3726a194975f38c40812db05a18670d5b440f025e0a1702b434a3aaa
  binding:
    path: docs/plans/PLAN-L7-676-release-consumer-dev-start.md
    plan_id: PLAN-L7-676-release-consumer-dev-start
    asset_id: plan:aae8bf0e313f8688fbad4d4d8cf0a6a9
    revision: 8
    content_digest: sha256:ee63fc1fee5362051c286995d0617dfeccf26e62e9a0ede137e672ac06be83e6
  route:
  ...
  escape_reason: "PR #686 の新規成果物 src/cli.ts と
    ...
    generates に宣言し、origin/main の receipt tail へ re-chain する。"
---
...
7. PR-1 (identity / repo-root): PR #686 の新規成果物 `src/cli.ts` と `tests/release-consumer-dev-start-identity.test.ts` を confirmed PLAN の generates に追加し、origin/main の receipt tail へ re-chain する。
