---
plan_id: PLAN-L7-690-issue-binding-projection-state-contract
title: "PLAN-L7-690 (design): issue binding の projection_state 契約"
kind: impl
layer: L7
drive: agent
...
backprop_decision_reason: L7 issue binding 契約の追加であり、L0/L1 要件の意味は変更しないため
agent_slots:
  - role: tl
...
generates:
  - artifact_path: docs/plans/PLAN-L7-690-issue-binding-projection-state-contract.md
...
admission_receipt:
  schema_version: v2
  receipt_id: certificate:e3fab375ac6f056e27af7ade83a4b395
  command_id: plan-draft:forward:plan-l7-690-projection-state-contract:v4
  admitted_at: 2026-09-25T03:00:00.000Z
  source_digest: sha256:d5835df5f4d42433b615d9f6566b4a3dcae1353a31c359ab799cb9f631a8397b
  decision_digest: sha256:ad76ec9f633eacc3d885a76b056813d0f7546f16f32859b8d7ea1c7eb3047e54
  receipt_digest: sha256:f0d7864944e535184592b4c68b9c9eab6b7ba390303bcb9d6d7d5bb46ef553ad
  binding:
    path: docs/plans/PLAN-L7-690-issue-binding-projection-state-contract.md
    plan_id: PLAN-L7-690-issue-binding-projection-state-contract
    asset_id: plan:e3fab375ac6f056e27af7ade83a4b395
    revision: 1
    content_digest: sha256:d5835df5f4d42433b615d9f6566b4a3dcae1353a31c359ab799cb9f631a8397b
  route:
    signal: forward
    mode: forward
---

# PLAN-L7-690: issue binding の `projection_state` 契約
...
| `src/plan-admission/policy.ts:196` | 対象 | Forward 外 admission と issue binding 必須判定。 |
