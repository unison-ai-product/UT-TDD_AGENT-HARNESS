...
review_evidence:
  - reviewer: codex
    ...
    scope: >-
      ...
      reviewer family は codex。対象は本 PLAN の契約 freeze (inventory / 検出能力 oracle /
      順序契約 / slice 束縛表) のみであり、S1-a (#471) / S1-c (#472) / Slice 2 (#473) の
      実装完了や Issue #450 の完了は主張しない。
    citations:
...
§9 のとおり本 PLAN の confirm は **pair-freeze の確定のみ**を意味する。将来 slice の完了を DoD に置くと §9 と矛盾し、未達を checked と偽らない限り confirm できない。
...
- S1-b (#470) / S1-a (#471) / S1-c (#472) の 3 PR がいずれも exact-head CI Green と非著者 canonical receipt を持つ
