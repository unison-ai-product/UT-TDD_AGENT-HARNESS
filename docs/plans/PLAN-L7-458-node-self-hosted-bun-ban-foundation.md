...
|---|---|---|
| `CAND-NODEBOOT-001` | `NodeBootstrapReceipt`がNode executable、compiled ESM CLI、`package-lock.json`、build policyを単一receiptで封印する | 正常receiptをloadし、各digestと`compiled-esm-only`を照合 |
