...
title: "PLAN-REVERSE-27 (reverse): back-fill invariant-test-trace"
kind: reverse
layer: cross
workflow_phase: R4
...
agent_slots:
  - role: tl
    slot_label: "TL - invariant trace back-fill"
generates:
...
# PLAN-REVERSE-27 (reverse): back-fill invariant-test-trace

## §0 Position

Records the Reverse side for IMP-098.
...
- Preserve the reverse trace for invariant-test-trace.

## §3 工程表

### Step 1: [並列] observed gap record

Record that invariant trace was not previously machine-checkable.
...
- [x] PLAN-L7-28 requires this Reverse PLAN.
