---
plan_id: PLAN-L6-99-workflow-suggest-add-design
title: "PLAN-L6-99 (add-design): workflow suggest 合成器の L6 設計 — family map / drive×kind matrix / exit semantics"
kind: add-design
layer: L6
drive: agent
...
generates:
  - artifact_path: docs/plans/PLAN-L6-99-workflow-suggest-add-design.md
...
# PLAN-L6-99: workflow suggest 合成器の L6 add-design
