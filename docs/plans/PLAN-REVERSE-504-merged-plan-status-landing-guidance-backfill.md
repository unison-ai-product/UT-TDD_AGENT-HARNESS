---
plan_id: PLAN-REVERSE-504-merged-plan-status-landing-guidance-backfill
title: "PLAN-REVERSE-504: merged-plan-status landing guidance の上流契約整合"
kind: reverse
layer: cross
drive: db
workflow_phase: R1
...
updated: 2026-08-25
owner: Codex / Luna
parent_design: docs/plans/PLAN-L7-504-merged-plan-status-landing-guidance.md
...
generates:
  - artifact_path: docs/plans/PLAN-REVERSE-504-merged-plan-status-landing-guidance-backfill.md
    artifact_type: markdown_doc
dependencies:
  parent: docs/plans/PLAN-L7-504-merged-plan-status-landing-guidance.md
  requires: []
  blocks: []
  references:
    - docs/plans/PLAN-L7-54-merged-plan-status-gate.md
    - docs/plans/PLAN-RECOVERY-20-merged-plan-premerge-landing.md
    - docs/plans/PLAN-L7-504-merged-plan-status-landing-guidance.md
...
# PLAN-REVERSE-504: landing guidance の上流契約整合
...
- 本 Reverse は上記境界を R3/R4 で再確認し、L7 test-design の 504 trace と PLAN の evidence だけを
  更新対象とする。#391/#399/#388、Pack publication、worktree lifecycle は対象外とする。

## 3. Exit

`U-MPSTATUS-504-*` の test citation、targeted regression、typecheck、Biome、PLAN lint / backfill /
