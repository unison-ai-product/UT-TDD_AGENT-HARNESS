...
- **R3**: (a) handover=§6.8 governance で新 FR 不要 / (c) digest 活性化=current-plan は grounded。**(b) CURRENT.md 廃止は PO 認識確認** (ガバナンス表記変更)
