...
review_evidence:
  - reviewer: sol
    ...
    reviewed_at: "2026-08-31T07:27:12Z"
    tests_green_at: "2026-08-31T07:25:08Z"
    verdict: >-
      non-author preflight PASS / blocking 0。生成consumerのBun到達0、source rollback buildの維持、
      U-PACKBUN-003/004/006の独立mutation、S1-b外の非変更を確認した。
    worker_model: gpt-5.6-luna
    reviewer_model: gpt-5.6-sol
    plan_revision: 4432c4433f8b6c6ce8fa3f5b43644256322d2cdc
    subject_head: 4432c4433f8b6c6ce8fa3f5b43644256322d2cdc
    scope: >-
      PLAN-L7-522/L7-524、REVERSE-524、対test-design、setup/distribution/template/hook、
      U-PACKBUN-003/004/006、spawn/import/global/allowlist/pinとS1-b外の非干渉を対象とした。
    citations:
    ...
    green_commands:
      - kind: unit_test
        command: "node scripts/run-vitest-snapshot.ts tests/setup-bun-removal.test.ts tests/ban-lint-detection-power.test.ts --reporter=dot"
        runner: node
        scope: targeted
        exit_code: 0
        completed_at: "2026-08-31T07:25:08Z"
        ...
        anchor_commit: 68eb0546eb1b955470202b0c245f7a2730529b02
---
