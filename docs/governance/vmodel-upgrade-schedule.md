...
| PLAN-L5-17-plan-asset-workflow-ledger-physical-data | L5 | physical-data | L8 | PLAN-L4-23-forward-fsm-plan-asset-v2 | U19b: PLAN Asset v2 revision/event/evidence ledger物理境界 | yellow | draft | L8 pair、legacy collision migration設計待ち |
...
| PLAN-L6-71-plan-asset-canonical-migration-contracts | L6 | function-spec | L7 | PLAN-L5-17-plan-asset-workflow-ledger-physical-data | U20b: PlanAsset/Revision/Evidence/migration契約 | yellow | draft | L5-17 pair-freeze待ち |
| PLAN-L6-72-forward-fsm-evidence-policy-contracts | L6 | function-spec | L7 | PLAN-L6-71-plan-asset-canonical-migration-contracts | U20c: Forward FSM/reducer/transition/evidence policy契約 | yellow | draft | L6-71、L7 Red設計待ち |
...
| PLAN-L7-419-forward-fsm-transition-workflow-cli | L7 | implementation | L6 | PLAN-L6-72-forward-fsm-evidence-policy-contracts | U20i-3: Forward FSM/CLI | yellow | draft | U/P-FSM Red、REVERSE-419待ち |
...
| PLAN-L7-423-engine-swap-domain-objects-ports | L7 | implementation | L6 | PLAN-L6-75-engine-swap-domain-method-port-contracts | U20i-7: domain objects/ports移行 | yellow | draft | U-DOMAIN Red、cycle 0待ち |
...
| PLAN-L7-424-semantic-assessment-debt-router | L7 | implementation | L6 | PLAN-L6-76-semantic-assessment-debt-routing-contracts | U20i-8: semantic evaluator/debt router | yellow | draft | U-ASSESS Red、163 review待ち |
...
| PLAN-L7-425-independent-detector-meta-verifier | L7 | implementation | L6 | PLAN-L6-77-detector-compiler-meta-verifier-contracts | U20i-9: independent meta-verifier/receipts | yellow | draft | U/I/M-SP Red、mutation survivor 0待ち |
