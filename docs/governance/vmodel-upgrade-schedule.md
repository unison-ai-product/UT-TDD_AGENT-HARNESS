...
| PLAN-L6-83-forward-escape-issue-contract | L6 | function-spec | L7 | PLAN-L5-23-execution-ledger-github-physical-data | U23c: 通常Forward Issue不要 / escape Issue必須契約 | yellow | draft | U/P-EXEP RedとU-GHISS Red、drive enum接続待ち |
