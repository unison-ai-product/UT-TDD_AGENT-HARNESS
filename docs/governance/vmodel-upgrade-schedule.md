...
| PLAN-L6-71-plan-asset-canonical-migration-contracts | L6 | function-spec | L7 | PLAN-L5-17-plan-asset-workflow-ledger-physical-data | U20b: PlanAsset/Revision/Evidence/migration契約 | yellow | draft | U-PA-043〜047でcustody/claims/schema migration契約を再freeze中 |
...
| PLAN-L7-418-plan-asset-v2-adapter-migration-ledger | L7 | implementation | L6 | PLAN-L6-71-plan-asset-canonical-migration-contracts | U20i-2: PLAN Asset v2 adapter/migration | yellow | draft | U-PA-001〜042 Green。U-PA-043〜047 custody/evidence/schema migration、REVERSE-418待ち |
