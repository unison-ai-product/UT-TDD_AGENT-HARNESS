...
| PLAN-L6-68-memory-telemetry-lifecycle-contract | L6 | memory | L7 | PLAN-L7-412-schedule-live-session-digest | U17c-design: memory昇格nudge、telemetry消化、source解消の設計契約をfreeze | yellow | draft | feedback projectionと消化状態の分離を先に決定する。 |
