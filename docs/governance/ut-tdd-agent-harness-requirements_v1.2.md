...
>
> **FE/UI body population (2026-06-30、PLAN-L3-06 / PLAN-L5-09 / PLAN-L6-36)**: Harness central UI now has confirmed bodies for L3 `screen-functional`, L5 `ui-detail`, and L6 `screen-spec`. The vocabulary-first rule above remains the general product-selection rule; for this product, `frontend-design-coverage` now requires all six FE left-arm body files and reports pending 0.
