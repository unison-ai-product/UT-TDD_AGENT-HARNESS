...
| `DOC-L4-SECURITY` | `L4` | `security` | `security` | `gap` | `profile_controlled` | `draft` | `vmodel-security` | `docs/plans/PLAN-L4-16-security-design-slot.md` | `document_catalog_entries` | `true` | `true` |
