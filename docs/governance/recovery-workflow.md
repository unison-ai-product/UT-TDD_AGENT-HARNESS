...
|---|---|---|---|
| [PLAN-REC-001](../plans/PLAN-REC-001-internal-asset-recovery.md) | (a) 指示無視 (内部資産を UT-TDD 用に作り替える指示の不履行) | 内部資産 FR 前提抜け → L1/L3 | Step 1-2 実施中 (本ワークフロー構築に伴い再分類: 「認識ずれ」→「指示無視」) |
