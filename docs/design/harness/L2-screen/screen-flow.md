...
layer: L2
sub_doc: screen-flow
status: confirmed  # G2 freeze (PO サインオフ 2026-06-22、gate-design §2 G2=PASS)。本材料化 PLAN-L2-02。③ pair=L10-ux-validation-test-design.md (PLAN-RECOVERY-09、PLAN-L7-453 H4)。
