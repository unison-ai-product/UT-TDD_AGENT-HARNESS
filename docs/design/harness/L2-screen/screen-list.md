...
layer: L2
sub_doc: screen-list
status: placeholder  # 内容は本材料化済 (PLAN-L2-01)。confirmed への昇格は G2 freeze (PO サインオフ、PLAN-L2-00 Step 4) 時。gate-confirm (IMP-079) freeze 偽装防止に従い、G2=DEFER 中は placeholder を維持。
