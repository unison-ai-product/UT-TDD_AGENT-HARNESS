...
L2 PLAN-L2-03 本起票時、必要に応じて主要画面 (PM-01 / HM-02 / HM-03 / HM-04 / GD-01) の Low-Fi を本ファイルに追記する。それ以上の詳細 (High-Fi) は 外部依頼。

## L10 UX refinement との関係

High-Fi モック確定が必要な場合 (例: L10 UX refinement 工程)、案件別に以下のいずれかで進める:
- **harness 内保持**: 本 sub-doc に img link / SVG / 添付参照で High-Fi 保存
- **外部依頼**: PO 提供の外部成果物 (Figma URL / Excalidraw 等) を参照欄に記載
