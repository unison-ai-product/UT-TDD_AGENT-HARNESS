...
| 観点 | 内容 |
|------|------|
| **対応 BR/UX/FR-L1** | BR-05 / BR-07 / FR-L1-06 / FR-L1-07 |
...
| `docs/design/harness/L2-screen/wireframe.md` | 各画面のレイアウト・情報配置 (Low-Fi で OK) | §3 表示要望 / §1.PM.01〜§1.GD.01 情報要素。**主要画面 (PM-01 4 階層 / HM-02 heat map / HM-03 動的配線 / HM-04 DB / GD-01 サイドナビ) は Low-Fi ASCII art で構造を示す** | **省略可 + PO 外部吸収** (A-39 採用、Low-Fi のみ harness 内、**High-Fi モックは PO 外部 (Figma 等)**) |
...
|-------|--------|--------|-----------|
| **BR-01** | PM-01 / PM-02 | PM-04 (Trace) | L0-L14 通し進捗の俯瞰 + 工程 deep-dive + trace 整合 |
...
| **BR-07** | PM-04 (Trace + W-pair) | HM-07 (Doctor) | ratchet 3 軸 = trace 切れ / balance_ratio / ID 追随 |
...
| **FR-L1-21** (テスト観点 W 字ゲート) | PM-04 / HM-07 | W-pair 状態 + Doctor 検出 |
...
| **FR-L1-31** (コンテキスト管理) | HM-05 | skill 注入タブ + 文脈管理 |
...
| **PM-03** | BR-02 / BR-05 / UX-03 | FR-L1-05 / FR-L1-11 / FR-L1-16 / FR-L1-17 |
| **PM-04** | BR-01 / BR-03 / BR-07 | FR-L1-03 / FR-L1-18 |
| **PM-05** | UX-03 | FR-L1-01 |
