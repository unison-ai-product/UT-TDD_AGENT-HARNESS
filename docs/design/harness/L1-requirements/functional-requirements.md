...
| `helix-interrupt` (cross-cutting-mechanisms.md 行 18) | `ut-tdd interrupt` (Sprint 割り込みイベント記録、L4 CLI 設計 carry) | FR-L1-11 |
| `helix-debt` | `ut-tdd debt` (技術負債台帳登録、L4 CLI 設計 carry) | FR-L1-11 |
| `helix-drift-check` | `ut-tdd drift-check` (drift 検出非ブロック実行、L4 CLI 設計 carry) | FR-L1-11 |
| `helix-readiness` | `ut-tdd readiness` (後工程 PLAN 先送り判定、L4 CLI 設計 carry) | FR-L1-11 |
