...
| BR-22 | OT-22 | 内部資産 (roster/skill pack/command) が UT-TDD 用に再構築済 + HELIX 前提残存 0 の確認 |
...
| BR-22 内部資産 (subagent roster / skill pack / command) の UT-TDD 化詳細 (FR-L1-46〜49 / 棚卸 = internal-asset-inventory.md / porting-map W6/W7/W10) | L3 FR / L4-L6 | Recovery PLAN-RECOVERY-01、設計増分は L4-L6 |
