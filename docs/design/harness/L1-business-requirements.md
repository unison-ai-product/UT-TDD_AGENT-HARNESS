...
> **status**: confirmed (PO 確定 2026-05-27。専門サブエージェント review 通過 + P0/P1 修正反映済)
...
concept の 4 問題 P1-P4 → BR-01/02/03/04、§1.4 GitHub 正本 → NFR-05、ヒアリング → 価値V/BR-06/NFR-01〜04/07/UX。L3 で FR-* が本書 BR-* から trace する。
