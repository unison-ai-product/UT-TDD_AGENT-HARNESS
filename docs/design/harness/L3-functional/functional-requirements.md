...
| FR-L1-46 / FR-L1-47 / FR-L1-48 / FR-L1-49 (内部資産 UT-TDD 化: subagent roster / skill pack curate / command CLI 化 / drift lint) | P1 | L4-L6 carry | BR-22 派生、Recovery PLAN-REC-001。roster=W6/W7・skill pack=W10・drift lint=IMP-033 (L6-L7)。棚卸 = internal-asset-inventory.md |
