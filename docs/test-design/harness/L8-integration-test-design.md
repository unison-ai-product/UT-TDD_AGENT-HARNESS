...
> **layer**: L8 (結合テスト設計) / **artifact**: ④ テスト設計 (W-model 右、② L5 詳細設計 全 sub-doc と対)
> **pair (W-model L5↔L8)**: `docs/design/harness/L5-detailed-design/{physical-data,module-decomposition,internal-processing,if-detail}.md` 4 sub-doc 全体 ↔ 本書 1 doc
...
| IT-CONTRACT-02 | `gate` の post + invariant (§4/§5) | gate pass → phase.yaml + gate_runs 証跡 / W-model 順序 invariant |
