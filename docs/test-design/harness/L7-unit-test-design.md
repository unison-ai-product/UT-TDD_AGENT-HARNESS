...
`tests/live-review-projection.test.ts` / `tests/claude-memory-wake.test.ts` (`U-RVATT-023` / `025`)。
残る4候補はD3a live projection consumer実装で実repo lifecycle testへ1:1に昇格する。
