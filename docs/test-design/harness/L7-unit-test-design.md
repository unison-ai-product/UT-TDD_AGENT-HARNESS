...
| `U-WTTOPO-015` | PF3 / `PLAN-L7-477` | empty factsとadvisory finding factsをdoctor consumerへ個別入力 | emptyは出力なし。findingは表示するがhard-gate/CI成功判定を変更しない。`tests/worktree-topology-doctor.test.ts` |
