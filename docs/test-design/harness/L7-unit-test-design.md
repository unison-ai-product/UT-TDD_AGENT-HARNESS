...
| `U-RGK-WIRE-015` | token/3 lease/recovery proofのcanonical fieldを固定しauthenticator有無でpreimage生成 | wire DTOはauthenticator必須、authentication preimageはそのfieldだけ除外。自己包含0、他field一要素変異はverify拒否 |
