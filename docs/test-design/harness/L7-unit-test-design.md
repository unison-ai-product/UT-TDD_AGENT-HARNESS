...
combined payload field mutation、session exact count、outer/edge欠測、v1 ID/revision mismatch、expired issued_at、
composition-root emergency denyを個別negativeにする。
