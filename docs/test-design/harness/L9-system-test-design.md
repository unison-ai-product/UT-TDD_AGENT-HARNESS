...
| `CAND-NODEBOOT-207` | 5-state cutover receipt chain | guard evidenceなし、非隣接/skip/reverse、別revision replay、review/chain digest不一致を全て拒否し、projectionはvalidated chainと一致 |
