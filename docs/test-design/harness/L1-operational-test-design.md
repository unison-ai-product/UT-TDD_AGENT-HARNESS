...
> **pair (V-model L1↔L14)**: `../../design/harness/L1-requirements/{business,functional,screen,technical,nfr}-requirements.md` の 5 sub-doc 全体 ↔ 本書 1 doc (V2 HELIX-workflows 正本に従い、L1 = 5 sub-doc 構造、運用テスト設計は L14 pair として 1 本)
...
| **OT-15** | PM-01〜PM-05 (PM 画面群全般) | L1 画面要求として宣言した PM カテゴリ 5 画面 (PM-01 俯瞰ダッシュボード / PM-02 工程ビュー / PM-03 Gate+詰まり要因 / PM-04 Trace+V-pair / PM-05 Handover) が L2 モックで lift され、PO が「これで業務要求を満たす」と判定できる | L2 mock で PO 判定 pass |
