...
export const PROFILES: Record<VerificationProfileId, VerificationProfile> = {
  "node-unit": {
    id: "node-unit",
    label: "Node/Vitest unit regression",
  ...
  doctor: {
    ...
    command: "node dist/ut-tdd.mjs doctor",
    sourceType: "builtin",
    packageName: null,
    executable: "node",
    authEnv: [],
  ...
  "mcp-inspector-smoke": {
    ...
    riskTier: "medium",
    installHint: "npm install --save-dev @modelcontextprotocol/inspector",
  ...
  "playwright-mcp": {
    ...
    defaultEnabled: false,
    riskTier: "medium",
    installHint: "npm install --save-dev @playwright/mcp",
  ...
  "vitest-browser-playwright": {
    ...
    defaultEnabled: false,
    riskTier: "low",
    installHint: "npm install --save-dev @vitest/browser-playwright",
  ...
  testcontainers: {
    ...
    defaultEnabled: false,
    riskTier: "medium",
    installHint: "npm install --save-dev testcontainers",
  ...
  msw: {
    ...
    defaultEnabled: false,
    riskTier: "low",
    installHint: "npm install --save-dev msw",
...
> = {
  "node-unit": ["node", ["scripts/run-vitest-snapshot.ts"]] as const,
  doctor: ["node", ["dist/ut-tdd.mjs", "doctor"]] as const,
