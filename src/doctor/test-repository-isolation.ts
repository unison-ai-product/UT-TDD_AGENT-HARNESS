...
// PLAN-L7-509: setup:9 は U-SETUP-009b3 の fail-close 検査追加による +1 (旧 8)。
const CONTRACT_ROWS = `
...
runtime-portability:2 screen-impl-pair-freeze:1 self-pair-normative-guard:1 setup-agent-floor:2 setup:9 skill-assignment:1 state-db:1
