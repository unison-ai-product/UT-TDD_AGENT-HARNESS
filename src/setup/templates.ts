...
export const BUILTIN_GITHUB_TEMPLATES: TemplateSet = {
  ...
  "common/ut-tdd.mjs": [
    ...
    'if (!pointer || typeof pointer.entry_path !== "string" || !pointer.entry_path.startsWith(consumerRoot)) { console.error("consumer_runtime_resolution_denied"); process.exit(78); }',
    "const result = spawnSync(process.execPath, [pointer.entry_path, ...process.argv.slice(2)], {",
    "  cwd: consumerRoot,",
    '  stdio: "inherit",',
    "  windowsHide: true,",
    "});",
    "",
    "if (result.error) {",
    '  console.error("consumer_runtime_resolution_denied");',
    "  process.exit(78);",
    "}",
    "",
  ...
  "adapter/.claude/settings.json": [
    ...
    '            "type": "command",',
    '            "command": "node",',
    `            "args": ${JSON.stringify([WRAPPER_HOOK_LAUNCHER, ...wrapperHookArgs("subagent-stop")])},`,
    '            "timeout": 5,',
