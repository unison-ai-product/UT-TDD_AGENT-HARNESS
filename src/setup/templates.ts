...
export const BUILTIN_GITHUB_TEMPLATES: TemplateSet = {
  ...
  "common/ut-tdd.mjs": [
    ...
    'const command = existsSync(localBin) ? localBin : "ut-tdd";',
    ...
    '  console.error("[ut-tdd-wrapper] Add UT-TDD as a project dependency or verify `ut-tdd --help` in this repository shell.");',
