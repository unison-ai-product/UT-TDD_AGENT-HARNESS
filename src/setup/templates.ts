...
export const BUILTIN_GITHUB_TEMPLATES: TemplateSet = {
  ...
  "common/ut-tdd.mjs": [
    ...
    "const resolvedCli = existsSync(sourceCli) ? sourceCli : null;",
    "if (!resolvedCli) {",
    '  console.error("[ut-tdd-wrapper] Project-local UT-TDD entrypoint was not found.");',
    '  console.error("[ut-tdd-wrapper] Keep the setup Pack checkout available or run setup again in this repository.");',
    "  process.exit(127);",
    "}",
    ...
    '  console.error("[ut-tdd-wrapper] Keep the setup Pack checkout available, or verify `ut-tdd --help` in this repository shell.");',
